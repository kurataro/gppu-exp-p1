...
// Define 'Water Fantom'
   ...
   G4double leng_X_Water = 30.0*cm;           // X-full-length of world
   G4double leng_Y_Water = 30.0*cm;           // X-full-length of world
   G4double leng_Z_Water = 30.0*cm;           // X-full-length of world
